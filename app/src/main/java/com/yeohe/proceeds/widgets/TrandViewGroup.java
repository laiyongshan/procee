...
public class TrandViewGroup<X extends TextView>  extends ViewGroup {
    ...
    private final int HorInterval = 40; //水平间隔
    ...
    private int itemTextColorNor = Color.parseColor("#606060");
    ...
    public TrandViewGroup(Context context) {
        this(context, null);
    }


    public TrandViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
...
//        Log.e(TAG, "onMeasure:" + viewWidth + ":" + viewHeight);
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    onGroupItemClickListener.onGroupItemClick(itemPos,viewId);
    ...
    private void setItemPadding(X view) {
        if (view instanceof Button) {
            ...
            view.setPadding(textModePadding-20, 20, textModePadding-20,20);
        }
    }
    ...
    public interface OnGroupItemClickListener {
        void onGroupItemClick(int item,int viewId);
    }
